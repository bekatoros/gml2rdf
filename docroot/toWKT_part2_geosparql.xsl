...
<!--
<xsl:variable name="typeWKT"><xsl:value-of select="concat('http://www.opengis.net/gml#','wktLiteral')" /></xsl:variable>
...
<rdf:Description><geo:asWKT    rdf:datatype="http://www.opengis.net/ont/geosparql#wktLiteral" ><xsl:value-of select="$epsg" />

		<xsl:value-of select="concat(' POLYGON((', $MINX, ' ', $MINY, ', ', $MAXX, ' ', $MINY, ', ', $MAXX, ' ', $MAXY, ', ', $MINX, ' ', $MAXY, ', ', $MINX, ' ', $MINY, ')) ^^geo:wktLiteral')"/>
</geo:asWKT>
<rdf:type rdf:resource="http://www.opengis.net/gml#Polygon"/>
	...
	<rdf:Description><geo:asWKT    rdf:datatype="http://www.opengis.net/ont/geosparql#wktLiteral" ><xsl:value-of select="$epsg" />
	<xsl:value-of select="concat(' POLYGON((', $MINX, ' ', $MINY, ', ', $MAXX, ' ', $MINY, ', ', $MAXX, ' ', $MAXY, ', ', $MINX, ' ', $MAXY, ', ', $MINX, ' ', $MINY, ')) ^^geo:wktLiteral')"/>
</geo:asWKT><rdf:type rdf:resource="http://www.opengis.net/gml#Polygon"/>
</rdf:Description>
	...
	<xsl:template match="gml:Point">
		<xsl:call-template name="gml:srsName"/>
<rdf:Description><geo:asWKT    rdf:datatype="http://www.opengis.net/ont/geosparql#wktLiteral" ><xsl:value-of select="$epsg" />
<!-- <geo:asWKT  rdf:datatype="http://www.opengis.net/ont/geosparql#wktLiteral" >&lt;http://www.opengis.net/def/crs/EPSG/0/2100&gt; --><xsl:text> POINT</xsl:text>
<xsl:call-template name="gml:posList"/>
<!--<xsl:text>^^geo:wktLiteral </xsl:text>-->
</geo:asWKT>
<rdf:type rdf:resource="http://www.opengis.net/gml#Point"/>
</rdf:Description>
...
<xsl:text> LINESTRING</xsl:text>
		<xsl:call-template name="gml:posList"/>
		<!--<xsl:text>^^geo:wktLiteral </xsl:text>--></geo:asWKT>
<rdf:type rdf:resource="http://www.opengis.net/gml#LineString"/>
</rdf:Description>	</xsl:template>
...
<xsl:text> MULTIPOINT(</xsl:text>
		...
		<xsl:text>) </xsl:text></geo:asWKT>
<rdf:type rdf:resource="http://www.opengis.net/gml#MultiPoint"/>
</rdf:Description>	</xsl:template>
...
<xsl:text> MULTILINESTRING(</xsl:text>
		...
		<xsl:text>) </xsl:text></geo:asWKT>
<rdf:type rdf:resource="http://www.opengis.net/gml#MultiLineString"/>
</rdf:Description>	</xsl:template>

	<xsl:template match="gml:Curve">
		<xsl:call-template name="gml:srsName"/><rdf:Description><geo:asWKT    rdf:datatype="http://www.opengis.net/ont/geosparql#wktLiteral" ><xsl:value-of select="$epsg" />
...
<xsl:for-each select="gml:polygonMember//gml:Polygon">
		...
		<xsl:text>) </xsl:text></geo:asWKT>
<rdf:type rdf:resource="http://www.opengis.net/gml#MultiPolygon"/>
</rdf:Description>	</xsl:template>
...
<xsl:text> GEOMETRYCOLLECTION(</xsl:text>
		...
		<xsl:text>) </xsl:text></geo:asWKT>
<rdf:type rdf:resource="http://www.opengis.net/gml#GeometryCollection"/>
</rdf:Description>	</xsl:template>
